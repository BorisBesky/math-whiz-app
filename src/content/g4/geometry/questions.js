...
export function generateLinesAndAnglesQuestion(difficulty = 0.5) {
  // Scope: relationships between lines (parallel, perpendicular, intersecting).
  // Basic definitions of point/line/ray/line-segment belong to the
  // "points lines rays" subtopic and are generated by
  ...
  const questionTypes = [
    ...
    {
      question: "Two lines that cross each other at a single point (but not at a right angle) are called:",
      correctAnswer: "intersecting",
      options: ["parallel", "perpendicular", "curved"],
      hint: "The lines meet — but not at 90°. Parallel lines never meet at all.",
    },
    {
      question: "Which symbol is used to show that two lines are parallel?",
      correctAnswer: "∥",
      options: ["⊥", "≅", "∠"],
      hint: "Parallel lines are shown with two little slashes that look like the lines themselves.",
    },
    {
      question: "Which symbol is used to show that two lines are perpendicular?",
      correctAnswer: "⊥",
      options: ["∥", "≅", "∠"],
      hint: "The symbol looks like an upside-down T — one line standing straight up on another.",
    },
  ];
