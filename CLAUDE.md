...
- `classes.js` `handleDeleteClass` — remove-with-retention for all enrolled students
...
"Remove-with-retention" = only strip a teacher from a student's profile if no *other* class still connects them.
